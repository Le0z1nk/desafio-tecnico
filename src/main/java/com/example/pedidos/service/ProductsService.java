...
public class ProductsService {
	...
	public String cadastrar(ProductsDados dados) {
		var produto = new Products(dados.id(),dados.name(), dados.category(), dados.price_cents(), dados.active());
		repository.save(produto);
		return "cadastro do produto feito com sucesso";
	}
}
